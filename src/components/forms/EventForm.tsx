    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div>
          ...
          <Input id="guests" name="guests" type="number" min="1" required placeholder="50" />
        </div>
        <div>
      ...
      <div>
        <Label htmlFor="notes">Message / Requirements</Label>
        <Textarea id="notes" name="notes" placeholder="Any specific requirements or questions..." />
      </div>
